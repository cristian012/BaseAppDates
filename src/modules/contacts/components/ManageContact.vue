<template lang="pug">
    v-dialog(v-model="manageContact" max-width="600" persistent)
        v-form(ref="form" v-model="valid" lazy-validation)
            .v-modal
                .v-modal-title
                    v-btn.v-btn-close(icon flat color="primary" @click="manageContact = false")
                ...
                v-container.v-modal-content(fluid grid-list-lg)
                    .flex-0
                        v-layout(row wrap)
                            ...
                            v-flex(xs12 sm6)
                                v-text-field(v-model="job" :label="$t('Cargo')" color="success")
                ...
                .v-modal-actions
                    .v-btns.justify-end
                        v-btn(icon dark color="dark lighten-1" @click="manageContact = false")
